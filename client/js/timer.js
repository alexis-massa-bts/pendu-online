...
function config() {
    ...
    $config.loadingBars_color =  '#193b38';
    $config.loadingBars_background_color = '#193b38';

    // Countdown Timer
    $config.timer_color = '#FFFFFF';
    $config.timer_font_weight = 700;
    $config.timer_font = 'Montserrat';
    $config.timer_font_size = 20;
...
function setTimer($distance) {
    ...
    if(days !== 0) {
        ...
        window.location('selection-niveaux.php');
    }
